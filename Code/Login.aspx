<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Group5_QLCGP.WebForm1" %>

<!--#include file ="header.html"-->
 
    <form id="form1" runat="server"><div class="wrapper row1">
  <section id="ctdetails" class="hoc clear"> 
        ...
        <div style="height: 448px">
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Sign in" Width="158px" />
